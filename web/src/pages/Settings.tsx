      ...
      <div style={{ flex: 1, background: 'rgba(0,0,0,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ background: t.surfaceAlt, borderRadius: 12, boxShadow: '0 16px 48px rgba(0,0,0,0.5)', width: 480, overflow: 'hidden' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingLeft: 20, paddingRight: 16, paddingTop: 14, paddingBottom: 14 }}>
            <span style={{ fontSize: 16, fontWeight: 600, color: t.textPrimary }}>Settings</span>
          ...
          <Section title="General">
            ...
            <Row label="Auto refresh">
              <div style={{ display: 'flex', gap: 12 }}>
                <div style={{ ...chipBase, background: t.accentBlue, color: '#fff' }}>5m</div>
                <div style={{ ...chipBase, background: t.surfaceHover, color: t.textSecondary }}>30m</div>
                <div style={{ ...chipBase, background: t.surfaceHover, color: t.textSecondary }}>60m</div>
              </div>
            </Row>
          </Section>
          ...
          <Section title="Display">
            ...
            <Row label="Theme">
              <div style={{ display: 'flex', alignItems: 'center', gap: 4, height: 28, paddingLeft: 10, paddingRight: 10, borderRadius: 4, background: t.surfaceHover, cursor: 'pointer' }}>
                <span style={{ fontSize: 12, fontWeight: 500, color: t.textPrimary }}>Dark</span>
          ...
          <Section title="Privacy">
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <span style={{ fontSize: 12, color: t.textSecondary }}>Local data only - No cloud sync</span>
            </div>
          </Section>
        </div>
      </div>
